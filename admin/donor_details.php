<?php
// filepath: /c:/xampp/htdocs/bloodmg/admin/donor_details.php
require('../config.php');
...
if (isset($_REQUEST['D_name'])) {
    ...
    if ($result) {
        echo "<div class='alert alert-success' role='alert'>
                  Donor registered successfully. <a href='admin_dashboard.php' class='alert-link'>Go to home page</a>.
              </div>";
    } else {
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse nav_elements" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../dashboard.php#aboutus">About Us</a>
                        </li>
                    </ul>
                </div>
            </div>
